...
class HumanoidEnv(LocomotionEnv):
    ...
    def __init__(self, cfg: HumanoidEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.default_ori_dict = {
            "torso": (0.07, (0.0, -0.14, 0.0), (0.0, 0.14, 0.0)),
            ...
            "left_right_foot": (0.027, (-0.097, -0.00256, 0.0), (0.167, 0.02256, 0.0)),
            "left_thigh": (0.06, (0.0, 0.002, 0.06), (0.0, -0.012, -0.4)),
            "left_shin": (0.05, (0.0, 0.0, 0.049), (0.0, 0.0, -0.349)),
            "right_left_foot": (0.027, (-0.097, 0.00256, 0.0), (0.167, -0.02256, 0.0)),
            "left_left_foot": (0.027, (-0.097, 0.017, 0.0), (0.167, 0.043, 0.0)),
            "right_upper_arm": (0.04, (-0.023, 0.023, 0.023), (0.183, -0.183, -0.183)),
            "right_lower_arm": (0.031, (-0.008, -0.008, -0.008), (0.188, 0.188, 0.188)),
            "right_hand": (0.04, (0, 0, 0), (0, 0, 0)),
            "left_upper_arm": (0.04, (-0.023, -0.023, 0.023), (0.183, 0.183, -0.183)),
            "left_lower_arm": (0.031, (-0.008, 0.008, -0.008), (0.188, -0.188, 0.188)),
